output "spring_cloud_app_mysql_associations_id" {
  ...
  value       = { for k, v in azurerm_spring_cloud_app_mysql_association.spring_cloud_app_mysql_associations : k => v.id if v.id != null && length(v.id) > 0 }
}
output "spring_cloud_app_mysql_associations_database_name" {
  ...
  value       = { for k, v in azurerm_spring_cloud_app_mysql_association.spring_cloud_app_mysql_associations : k => v.database_name if v.database_name != null && length(v.database_name) > 0 }
}
output "spring_cloud_app_mysql_associations_mysql_server_id" {
  ...
  value       = { for k, v in azurerm_spring_cloud_app_mysql_association.spring_cloud_app_mysql_associations : k => v.mysql_server_id if v.mysql_server_id != null && length(v.mysql_server_id) > 0 }
}
output "spring_cloud_app_mysql_associations_name" {
  ...
  value       = { for k, v in azurerm_spring_cloud_app_mysql_association.spring_cloud_app_mysql_associations : k => v.name if v.name != null && length(v.name) > 0 }
}
output "spring_cloud_app_mysql_associations_password" {
  ...
  value       = { for k, v in azurerm_spring_cloud_app_mysql_association.spring_cloud_app_mysql_associations : k => v.password if v.password != null && length(v.password) > 0 }
  sensitive   = true
}
output "spring_cloud_app_mysql_associations_spring_cloud_app_id" {
  ...
  value       = { for k, v in azurerm_spring_cloud_app_mysql_association.spring_cloud_app_mysql_associations : k => v.spring_cloud_app_id if v.spring_cloud_app_id != null && length(v.spring_cloud_app_id) > 0 }
}
output "spring_cloud_app_mysql_associations_username" {
  ...
  value       = { for k, v in azurerm_spring_cloud_app_mysql_association.spring_cloud_app_mysql_associations : k => v.username if v.username != null && length(v.username) > 0 }
}
